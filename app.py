...
if uploaded_file is not None:
    ...
    # Intelligent date parsing: handles DD-MM-YYYY, MM-DD-YYYY, YYYY-MM-DD
    ...
    if st.button("Run Causal Analysis"):
        ...
        if st.button("📄 Download PDF Report"):
            ...
            st.download_button(label="Download Report", data=pdf_bytes, file_name="causalcoach_report.pdf", mime="application/pdf")
